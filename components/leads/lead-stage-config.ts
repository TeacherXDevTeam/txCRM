export const STAGES = [
  ...
  { key: "teklif_istendi",  label: "Teklif İstendi",  color: "border-t-yellow-400",  bg: "bg-yellow-50",  count_color: "bg-yellow-200 text-yellow-700" },
...
export const STAGE_LABEL: Record<string, string> = {
  ...Object.fromEntries(ALL_STAGES.map((s) => [s.key, s.label])),
  // DB'de mevcut ama pipeline'da gösterilmeyen eski değerler (ham key görünmesin)
